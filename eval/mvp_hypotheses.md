...
|---|---|---|---|---|
| **H1** | Workflow nhận diện đúng intent và route tới 1 trong 6 tools | ≥80% golden set khớp `expected_tool` *(bar chốt spec §7)* | Intent lệch tool → gọi sai API, UX lạc | Smoke + Quantitative |
...
| H2 | ST-06 track đơn giả | Layer ① (case 21, 22) | Q-02 user nêu giá sai |
| H3 | ST-04, ST-05 thiếu param | Layer ② (case 23, 24, 29) | Q-03 "thêm món đó" |
| H4 | ST-07..ST-08 out-of-scope & confirm | Layer ③④ (case 14, 15, 20, 25, 26, 30) | Q-04 jailbreak + Q-05 sửa đơn |
