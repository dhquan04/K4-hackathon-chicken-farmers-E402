...
- **Kết quả các lượt chạy:**
  ...
  |---|---|---|---|---|---|
  | 001 | 2026-07-31T03:23:00Z | **29/30** (96,7%) | 8/8 | — | Case #28 fail — input không dấu. `eval/runs/run-001.md` |
...
| — | Giữ hỏi lại khi "món đó" mơ hồ | Phiên #3 — user chấp nhận trade-off tin cậy |
